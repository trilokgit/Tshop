    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('PENDING', 'Pending'), ('PLACED', 'Placed'), ('CANCLED', 'Canceled'), ('COMPLITED', 'Completed')], max_length=15)),
                ('payment_method', models.CharField(choices=[('COD', 'Case On Delivery'), ('ONLINE', 'Online')], max_length=15)),
